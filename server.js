...
var server = http.createServer(function (request, response) {
  ...
  if (path === '/index.html') {
    ...
    response.end()
  } else if (path === '/red.html') {
    response.statusCode = 200
    response.setHeader('Content-Type', 'text/html;charset=utf-8')
    response.write(fs.readFileSync('./red.html'))
    response.end()
  } else if (path === '/msg.xml') {
    response.statusCode = 200
    response.setHeader('Content-Type', 'text/xml;charset=utf-8')
    response.write(fs.readFileSync('./msg.xml'))
    response.end()
  } else if (path === '/person.json') {
    response.statusCode = 200
    response.setHeader('Content-Type', 'text/json;charset=utf-8')
    response.write(fs.readFileSync('./person.json'))
    response.end()
  } else {
